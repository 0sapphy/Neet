...
export const NODE_ENV = z.nativeEnum(NodeEnvironment, { invalid_type_error: "ENV:NODE_ENV needs to be typeof string", required_error: "ENV:NODE_ENV is a required variable, not found in .env!" })